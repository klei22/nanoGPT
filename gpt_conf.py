...
class GPTConfig:
    ...
    abs_pos_embedding_variant: str = "default" # options: "default", "cyclic"
    abs_pos_cyclic_periods: List[int] = field(default_factory=list)
    abs_pos_cyclic_random_start: bool = True
