...
def plot_3d_histogram(data, output_path):
    ...
    fig.update_layout(
        title="3D Histogram of Embeddings",
        scene=dict(
            xaxis_title="Column",
            yaxis_title="Value",
            zaxis_title="Count"
    ...
    fig.write_html(output_path + '_3d_histogram.html')
    fig.show()
...
def main():
    ...
    plot_3d_histogram(data, args.output_path)
