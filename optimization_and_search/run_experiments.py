...
def main():
    ...
    if args.progress:
        ...
        # Use a separate stderr console so this progress bar doesn't interfere with
        # the rich progress bar displayed inside train.py. This allows both bars to
        # render simultaneously when running experiments.
