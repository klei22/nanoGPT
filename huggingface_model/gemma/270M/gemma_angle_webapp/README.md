...
- Only the tokenizer, LM-head/output-embedding weight matrix, and vector magnitudes / L2 lengths are retained after model loading.
...
app/
  ...
  model_service.py     model loading, token search, angle math, CSV generation
