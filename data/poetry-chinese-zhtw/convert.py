...
IDS_ARITY: dict[str, int] = {
    ...
    "â¿¸": 2, "â¿¹": 2, "â¿º": 2, "â¿»": 2,
    "â¿¼": 2, "â¿½": 2, "â¿¾": 1, "â¿¿": 1,
    "ã‡¯": 2,  # U+31EF IDEOGRAPHIC DESCRIPTION CHARACTER SUBTRACTION
}
...
VARIATION_INDICATOR = "ã€¾"
ESCAPE = "\ue000"

FAMILY_OPERATORS: dict[str, frozenset[str]] = {
    "horizontal": frozenset(("â¿°", "â¿²")),
    "vertical": frozenset(("â¿±", "â¿³")),
    "surround": frozenset(("â¿´", "â¿µ", "â¿¶", "â¿·", "â¿¸", "â¿¹", "â¿º", "â¿¼", "â¿½")),
    "overlay": frozenset(("â¿»",)),
    "reflection": frozenset(("â¿¾",)),
    "rotation": frozenset(("â¿¿",)),
    "subtraction": frozenset(("ã‡¯",)),
