...
python train.py --device=cpu --out_dir $OUT_DIR --dataset file_byte_demo --batch_size 4 --block_size 16 --n_layer 2 --n_head 2 --n_embd 64 --max_iters 10 --lr_decay_iters 10 --eval_interval 5 --eval_iters 5 --dropout 0.0
