...
def parallel_mlp_forward(block, x: torch.Tensor, iter_num: int, kv_cache=None) -> torch.Tensor:
...
def attn_then_mlp_forward(block, x: torch.Tensor, iter_num: int, kv_cache=None) -> torch.Tensor:
...
def edgellm_asic_forward(block, x: torch.Tensor, iter_num: int, kv_cache=None) -> torch.Tensor:
...
class Block(nn.Module):
    ...
    def forward(self, x: torch.Tensor, iter_num: int, kv_cache=None):
        ...
        return self.block_forward(x, iter_num, kv_cache=kv_cache)
