...
GROUPED_QUANT_TRIALS=10 GROUPED_QUANT_ANGLE_STEP=10 \
...
- `grouped_quantization_sweep/`, containing the new d=2048 group-size sweep for
  symmetric/asymmetric scalar and power-of-two INT4 plus native NVFP4/MXINT8
  references.
