...
def parse_args():
    ...
    model_group.add_argument('--mole_n_experts', default=8, type=int, help="number of lookup table experts")
    model_group.add_argument('--mole_shared_mlp_size', default=None, type=int, help="hidden size of MoLE shared expert")
    model_group.add_argument('--mole_routed_mlp_size', default=None, type=int, help="hidden size of MoLE routed experts")
    ...
    model_group.add_argument('--mole_router_scheme', default="softmax", type=str, help="option to set routing scheme for MoLE layer, defaults to softmax")
