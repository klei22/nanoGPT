...
def parse_args():
    ...
    model_group.add_argument('--use_cope', default=False, action=argparse.BooleanOptionalAction)
    model_group.add_argument('--cope_first_layer_only', default=True, action=argparse.BooleanOptionalAction)
    model_group.add_argument("--cope_variant", type=str, default="phase", choices=["magnitude", "phase", "real", "hybrid", "hybrid_norm"])
    model_group.add_argument("--cope_phase_alpha", type=float, default=0.2)
    model_group.add_argument("--cope_gamma", type=float, default=1.0)
    model_group.add_argument("--cope_base", type=float, default=10000.0)
